...
const UploadFile = ({
	...
	const getFileType = file => {
		...
		const fileTypes = ["doc", "docx", "jpg", "jpeg", "mp3", "pdf", "png", "ppt", "xls", "xlsx", "zip"];
									...
									return (
										<div className={"file-item-wrapper"} key={key}>
											<div
												...
												style={{
													backgroundImage: !isDocument ? `url(${get(image, "thumbnails.normal.src", "")})` : null
												}}>
											...
											<div className="file-upload__dropzone">
												...
												<label className="label" htmlFor="file1">
													<div className="label__wrapper">
														...
														<p className="info-paragraph">{t("Расмни тортиб ўтинг ёки компьютердан юкланг")}</p>
													</div>
												</label>
											</div>
										</div>
