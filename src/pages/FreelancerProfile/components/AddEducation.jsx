      ...
      <div className="education__inner">
        <form onSubmit={handleSubmit}>
          ...
          <p className="education__text">
            <span className="education__textSpan">
              ...
              <div className="education__content" key={el.id}>
                <div className="education__texts">
                  ...
                  <div className="education__study">
                    ...
                    <span className="education__telecommunication">
                      {el.educationDegree}
                    </span>
                  </div>
                </div>
                ...
                <div className="education__icons">
                  <span
                    className="education__icon--create"
                    type="button"
                    onClick={changeEducationPage}
                  >
                    <ion-icon name="create-outline"></ion-icon>
                  </span>

                  <span
                    className="education__icon--delete"
                    onClick={() => deletEducation(el.id)}
                  >
          ...
          <div className="education__wrapper">
            <button
              type="click"
              className="education__buttonAdd"
